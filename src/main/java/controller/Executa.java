...
public class Executa {
	...
	public void ExecutaPrograma() throws Exception {
        ...
        System.out.println("TAG ZERO: "+ula.getTagZero());

        if(ula.getTagZero() == 0 && blocoDeControle.getBranch() == 1){
            memoriaDeInstrucoes.setPC(converte.to32Bits(Integer.toBinaryString(Integer.parseInt(memoriaDeInstrucoes.getPC(),2) + Integer.parseInt(signExtend, 2) - 1)));
            System.out.println("PC ==> " + Integer.parseInt(memoriaDeInstrucoes.getPC(),2) + "IM " + Integer.parseInt(signExtend, 2));
        }
